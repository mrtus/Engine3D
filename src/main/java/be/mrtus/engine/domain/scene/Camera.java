...
public class Camera extends Entity {
	...
	public Camera(Keyboard keyboard, Mouse mouse, Scene scene) {
		super(new Entity.Builder().transform(new MovableTransform.Builder().scale(new Vector3f(0.1f, 0.1f, 0.1f)).build()).controller(new CameraController(keyboard, mouse, scene)).model(new Model.ModelBuilder()
