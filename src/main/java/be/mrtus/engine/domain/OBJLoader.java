...
public class OBJLoader {
	...
	public static TerrainModel loadTerrainModel(String fileName) throws Exception {
	...
	private static TerrainModel reorderLists(List<Vector3f> posList, List<Vector2f> textCoordList, List<Vector3f> normList, List<Face> facesList) {
...
//		System.out.println(indicesLine);
		TerrainModel mesh = new TerrainModel.TerrainModelBuilder()
				.setPositions(posArr, indicesArr)
				.build();
		return mesh;
	}
